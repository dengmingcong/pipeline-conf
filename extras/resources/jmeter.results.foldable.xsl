    ...
    <xsl:template match="/testResults">
        ...
        <head>
            ...
            <style type="text/css"><![CDATA[
                ...
                #left-panel { position: absolute; left: 0; top: 0; bottom: 0; width: 300px; overflow: auto; border-right: 1px solid #bbbbc3; }
                ...
                #right-panel { position: absolute; left: 301px; right: 0; top: 0; bottom: 0; overflow: auto; background: white }
